  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.MyUser#_find_feeds
         * @methodOf lbServices.MyUser
         *
         * @description
         *
        ...
        "_find_feeds": {
          isArray: true,
          url: urlBase + "/MyUsers/:id/feeds",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.MyUser#_create_feeds
         * @methodOf lbServices.MyUser
         *
         * @description
         *
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Group#_find_members
         * @methodOf lbServices.Group
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Group#_create_members
         * @methodOf lbServices.Group
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Group#_deleteById_members
         * @methodOf lbServices.Group
         *
         * @description
         *
         ...
         */
        "_deleteById_members": {
          url: urlBase + "/Groups/:id/members/:userId",
          method: "DELETE"
        },
      }
    );
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Post#_create_attachments
         * @methodOf lbServices.Post
         *
         * @description
         *
         ...
         */
        "_create_attachments": {
          url: urlBase + "/Posts/:id/attachments",
          method: "POST"
        },
      }
    );
